  ...
  <header class="header" data-header>
    <div class="Container_1">
      ...
      <div class="header-action">
        ...
        <a href="FarmerHome.jsp" class="header-action-link">Home</a>
        <a href="AddProducts.jsp" class="header-action-link">Add Products</a>
        <a href="ViewProducts.jsp" class="header-action-link">View Products</a>
        <a href="ViewFarmerRequest.jsp" class="header-action-link">Received Request</a>
